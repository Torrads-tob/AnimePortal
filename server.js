...
const mongoUri = process.env.MONGODB_URI || "mongodb+srv://Log_in:cherylbubod1212@cluster0.sb6gr.mongodb.net/";
...
app.post('/signup', async (req, res) => {
  const { email, password, fullName, username, phoneNumber, crush } = req.body;

  try {
    if (!email || !password || !fullName || !username || !phoneNumber || !crush) {
...
store: MongoStore.create({ mongoUrl: "mongodb+srv://Log_in:cherylbubod1212@cluster0.sb6gr.mongodb.net/"}), // Use your MongoDB URI
cookie: {
